...
async def test_official_documented_models():
                        ...
                        failed_models.append(
                            {
                                ...
                                "error_detail": (
                                    error_data[:200] if error_data else "No detail"
                                ),
                            }
                        )
    ...
    print("\n📊 基于官方文档的真实测试结果:")
    print("   文档来源: https://docs.aimlapi.com/api-references/text-models-llm")
    ...
    if successful_models:
        ...
        for model in successful_models:
            print(
                f"   • {model['model_id']} ({model['provider']}) - {model['context_length']}"
            )
