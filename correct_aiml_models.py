...
async def test_official_models():
    ...
    official_models = {
        ...
        # Anthropic系列 (Claude)
        "claude-3-5-sonnet": {"provider": "Anthropic", "description": "Claude 3.5 Sonnet"},
        "claude-3-5-haiku": {"provider": "Anthropic", "description": "Claude 3.5 Haiku"},
        "claude-3-7-sonnet": {"provider": "Anthropic", "description": "Claude 3.7 Sonnet"},
        ...
        "deepseek-reasoner": {"provider": "DeepSeek", "description": "DeepSeek Reasoner V3.1"},
        
        # Alibaba系列
        "qwen-max": {"provider": "Alibaba", "description": "Qwen Max"},
        "qwen-plus": {"provider": "Alibaba", "description": "Qwen Plus"},
        "qwen3-235b-a22b-thinking-2507": {"provider": "Alibaba", "description": "Qwen3 235B Thinking"},
